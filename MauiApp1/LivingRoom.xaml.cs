...
public partial class Kitchen : ContentPage
{
    ...
    private void LivingRoomThermostat(object sender, EventArgs e)
    {
        ...
        var off = new Label();
        var ThermostatSwitch = new Switch();

        C.Add(del);                                              /* push to display stack */
        C.Add(l);
        C.Add(thermostat);
        C.Add(off);
        C.Add(ThermostatSwitch);
        ...
        void CoolToggle_ValueChanged(object sender, Syncfusion.Maui.Gauges.ValueChangedEventArgs e)   /* toggle cool */
        {
            ...
            ThermostatDisplay.toggleCool(value, off, ThermostatSwitch);
        }

        void HeatToggle_ValueChanged(object sender, Syncfusion.Maui.Gauges.ValueChangedEventArgs e)   /* toggle head */
        {
            double value = e.Value;
            ThermostatDisplay.toggleHeat(value, off, ThermostatSwitch);
        }

    }

    public void LivingRoomTv(object sender, EventArgs e)
    {
        string name = "Tv";
    ...
    private void LivingRoomOutlet(object sender, EventArgs e)
    {
        string name = "Outlet";
    ...
    private void LivingRoomCamera(object sender, EventArgs e)
    {
        string name = "Camera";
    ...
    private void LivingRoomLock(object sender, EventArgs e)
    {
        string name = "Lock";
